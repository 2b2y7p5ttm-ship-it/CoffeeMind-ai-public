...
export function BottomNav() {
  ...
  const { t } = useLanguage();
  if (location === '/add' || location.startsWith('/tasting/') || location.startsWith('/coach/') || ['/settings','/install','/welcome','/share','/backup','/account','/admin','/achievements'].includes(location)) return null;
