...
const ru = {
  wizard: {
    ...
    placeholders: {
      coffeeName: 'напр. Кочере Натурал', roaster: 'напр. Onyx Coffee Lab', country: 'Эфиопия', region: 'Иргачеффе',
      farm: 'Станция Кочере', variety: 'Хейрлум', producer: 'Мелкие фермеры', washingStation: 'Кочере',
      elevation: '1950', harvest: '2025', lot: 'Лот 24', dose: '20', yield: '300', time: '200', temperature: '94',
      grinder: 'Comandante C40', grindSetting: '24 щелчка', water: 'TWW', waterTds: '90', bloom: '45',
      dryAroma: 'Жасмин, черника, тёмный шоколад…', wetAroma: 'Черничный джем, вино, цветы…',
      firstImpression: 'Яркая фруктовая чашка с сочным телом…',
    },
...
const en: TastingCopy = {
  wizard: {
    ...
    coffeeName: 'Coffee name *', roaster: 'Roaster', country: 'Country', region: 'Region', farm: 'Farm', variety: 'Variety',
    placeholders: {
      coffeeName: 'e.g. Kochere Natural', roaster: 'e.g. Onyx Coffee Lab', country: 'Ethiopia', region: 'Yirgacheffe',
      farm: 'Kochere Station', variety: 'Heirloom', producer: 'Smallholders', washingStation: 'Kochere',
      elevation: '1950', harvest: '2025', lot: 'LOT-24', dose: '20', yield: '300', time: '200', temperature: '94',
      grinder: 'Comandante C40', grindSetting: '24 clicks', water: 'TWW', waterTds: '90', bloom: '45',
      dryAroma: 'Jasmine, blueberry, dark chocolate…', wetAroma: 'Blueberry jam, wine, florals…',
      firstImpression: 'Bright and fruity with a juicy mouthfeel…',
    },
    extendedBean: 'Extended bean passport', producer: 'Producer', washingStation: 'Washing station', elevation: 'Elevation, m', harvest: 'Harvest', lot: 'Lot', processing: 'Process', roastDate: 'Roast date',
