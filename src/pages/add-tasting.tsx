...
function Step6({ d, onSave }: { d: WizardData; onSave: () => void }) {
  ...
  return (
    <div className="space-y-5 pb-4">
      ...
      <motion.button type="button" onClick={onSave} whileTap={{ scale: 0.97 }}
...
export default function AddTasting() {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 6: return <Step6 d={data} onSave={handleSave} />;
      default: return null;
    }
  };

  return (
    <div className="flex flex-col h-[100dvh] bg-background overflow-hidden iphone-wizard">
      {/* Header */}
      ...
      {/* Footer */}
      {step < 6 && (
        <div className="px-4 py-4 iphone-footer-safe border-t border-white/[0.05] bg-background/88 backdrop-blur-sm flex-shrink-0">
