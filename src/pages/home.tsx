      ...
      <AnimatePresence>
        {showFilter && (
          <>
            ...
            >
              <div className="w-full max-w-[430px] bg-[#111]/95 backdrop-blur-2xl border-t border-white/[0.07] rounded-t-[32px] px-5 pt-4 iphone-sheet-bottom shadow-[0_-20px_60px_rgba(0,0,0,0.6)]">
