...
import { ChevronLeft, Trash2, Calendar, MapPin, Coffee, Droplets, Clock, Thermometer, Wind, Zap, FileText } from 'lucide-react';
    ...
    <div className="bg-background min-h-screen pb-10">
      ...
      <div className="relative h-52 overflow-hidden flex items-end"
        ...
        <button onClick={handleDelete}
          className="absolute top-14 right-4 w-10 h-10 bg-destructive/10 text-destructive rounded-full flex items-center justify-center hover:bg-destructive/20 transition-colors z-10"
