...
create table if not exists public.tastings (
  ...
  elevation_meters text default '',
  harvest_year text default '',
  ...
  grinder_model text default '',
  grind_setting text default '',
  water_name text default '',
  water_tds_ppm text default '',
  bloom_seconds text default '',
  dry_aroma text default '',
  wet_aroma text default '',
  first_impression text default '',
  aroma_score int default 5,
  flavor_score int default 5,
